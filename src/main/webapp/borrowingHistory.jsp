...
<body class="bg-gray-100 min-h-screen">
	<div class="container mx-auto px-4 py-8">
		...
		<main>
			<h2 class="text-2xl font-semibold text-gray-700 mb-4">Your
				...
				<div class="overflow-x-auto">
					<table class="w-full">
						<thead class="bg-gray-50">
							<tr>
								<th
									class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Borrow
									ID</th>
								<th
								...
								<th
									...
									Date</th>
								<th
									class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Return
									Date</th>
								<th
