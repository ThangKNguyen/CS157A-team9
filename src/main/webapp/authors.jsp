    ...
    <div class="flex h-screen">
            ...
            <nav class="mt-4">
                <ul>
                    <c:forEach var="author" items="${authors}">
                        <li>
                            <a href="BooksByAuthor?authorId=${author.id}"
        ...
        <main class="flex-1 p-8 overflow-y-auto">
            <div class="container mx-auto px-4 py-8">
                ...
                %>
                <h2 class="text-3xl font-bold text-gray-800 mb-6">No author selected</h2>
                <p class="text-gray-600 mb-4">Please select an author to view the books.</p>
                <%
                } else {
                %>
                <h2 class="text-3xl font-bold text-gray-800 mb-6">${authorName} Books</h2>
                <c:choose>
                    <c:when test="${empty books}">
                        <div class="w-full text-center py-12">
                            <p class="text-2xl font-semibold text-gray-700">No books by this author.</p>
                            <p class="mt-2 text-gray-500">Please check back later or try another author.</p>
                        </div>
                    </c:when>
                    <c:otherwise>
